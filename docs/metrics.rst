...
R-squared
----------
A common metric for evaluating regression algorithms that is easier to interpret than the RMSE. Intuitively, it is the proportion of the variance in the y variable that has been explained by the model. As long as the model contains an intercept term the R-squared should be between 0 and 1.
